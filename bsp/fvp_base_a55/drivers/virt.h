...
#define PL011_UART0_IRQNUM  (32 + 5)
...
/* VirtIO */
#define VIRTIO_MMIO_BASE    0x1C130000
#define VIRTIO_MMIO_SIZE    0x0000010000
#define VIRTIO_MAX_NR       1
#define VIRTIO_IRQ_BASE     (74)
#define VIRTIO_VENDOR_ID    0x764d5241  /* "arm" */
...
/* GICv2 */
#define GIC_PL390_DISTRIBUTOR_PPTR      0x2F000000
#define GIC_PL390_CONTROLLER_PPTR       0x2C000000
