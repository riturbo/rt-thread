...
#define UART_LC(base)   __REG32(base + 0x2c)
#define UART_CR(base)   __REG32(base + 0x30)
#define UART_IF(base)   __REG32(base + 0x34)
...
int rt_hw_uart_init(void)
{
    ...
    UART_LC(uart->hw_base) = (UART_LCR_WLEN_8);
    UART_CR(uart->hw_base) = (1 << 0) | (1 << 8) | (1 << 9) | (1 << 7);
    UART_IF(uart->hw_base) = 0;
#endif
